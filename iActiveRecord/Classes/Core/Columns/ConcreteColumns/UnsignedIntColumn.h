...
namespace AR {
    class UnsignedIntColumn: public ColumnInternal<unsigned int>
    {
    public:
        ...
        unsigned int toColumnType(id value) const override;
        id toObjCObject(unsigned int value) const override;
