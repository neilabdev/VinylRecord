...
namespace AR {
    class CharColumn : public AR::ColumnInternal<char>
    {
    public:
        ...
        char toColumnType(id value) const override;
        id toObjCObject(char value) const override;
        id toObjCDefaultObject(void) const;
    };
};
